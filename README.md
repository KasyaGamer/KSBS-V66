# KSBS 66.293
Private server emulator for Brawl Stars 66.293 (2026) written on Node.js

## Requirements
* [Node.js](https://nodejs.org)

## Setup
1. Download the repository by zip or type this into the Terminal: `git clone https://github.com/KasyaGamer/KSBS-V66.git`
...
4. Now it is finished and you can download my [client](https://mega.nz/folder/0mEzXY7T#epxmOPRH2s4YWXOT45JDiA).
